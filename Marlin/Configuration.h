...
#define Y_MIN_POS 0
#define Z_MAX_POS 125 // TEMPORARY - threaded rods are bent, above 100mm causes trouble
#define Z_MIN_POS 0
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.1603,80.007995,4010.4271,98}  // default steps per unit for ultimaker {78.7402,78.7402,200*8/3,760*1.1}920
